document.addEventListener('DOMContentLoaded', () => {
	...
	if (window.location.hash === '#accountModal' || window.location.hash === '#accountModal-register') {
		if (window.location.hash === '#accountModal-register') {
			const registerTab = modalElement.querySelector('[data-bs-target="#account-register-pane"]');
